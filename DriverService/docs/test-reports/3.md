# Situation
**Switching to use newer version of test**
...
~~~bash
    ...
    http_req_duration
    ✗ 'p(95)<800' p(95)=1.87s
    ✗ 'p(99)<1500' p(99)=12.47s

    http_req_failed
    ✓ 'rate<0.01' rate=0.63%

    position_fetch_duration
    ✗ 'p(95)<500' p(95)=9237.7
    ...
    ✓ 'rate>0.95' rate=98.92%


  █ TOTAL RESULTS

    checks_total.......: 383862 353.355407/s
    checks_succeeded...: 99.37% 381451 out of 383862
    checks_failed......: 0.62%  2411 out of 383862
    ...
    CUSTOM
    auth_duration..................: avg=3042.502667 min=300      med=317     max=15261  p(90)=11496.4  p(95)=13389.85
    auth_errors....................: 0.00%   0 out of 1500
    authenticated_vus..............: 1       min=1                max=1
    driver_starts..................: 1500    1.380791/s
    errors.........................: 100.00% 1207 out of 1207
    position_fetch_duration........: avg=1050.657774 min=31       med=50      max=15340  p(90)=3511     p(95)=9237.7
    position_fetch_success.........: 99.99%  75824 out of 75827
    position_update_duration.......: avg=84.739582   min=0        med=44      max=1143   p(90)=217      p(95)=253
    position_update_success........: 98.92%  111150 out of 112354
    position_updates...............: 111150  102.316597/s
    sign_ins.......................: 1500    1.380791/s

    HTTP
    http_req_duration..............: avg=504.84ms    min=0s       med=41.71ms max=15.33s p(90)=250.39ms p(95)=1.87s
      { expected_response:true }...: avg=507.25ms    min=26.56ms  med=41.68ms max=15.33s p(90)=250.64ms p(95)=1.96s
    http_req_failed................: 0.63%   1207 out of 191181
    http_reqs......................: 191181  175.987308/s

    EXECUTION
    iteration_duration.............: avg=4.16s       min=533.17ms med=3.52s   max=43.84s p(90)=7.42s    p(95)=7.91s
    iterations.....................: 188181  173.225727/s
    vus............................: 1       min=1                max=1500
    vus_max........................: 1500    min=1500             max=1500

    NETWORK
    data_received..................: 58 MB   53 kB/s
    data_sent......................: 39 MB   36 kB/s



                                                                                                         
running (18m06.3s), 0000/1500 VUs, 188181 complete and 0 interrupted iterations                          
default ✓ [======================================] 0000/1500 VUs  18m0s                                  
ERRO[1087] thresholds on metrics 'auth_duration, errors, http_req_duration, position_fetch_duration' have been crossed
~~~

## Metrics
~~~bash
Virtual machines: CPU usage peak ~ 55%, Memory usage peak ~ 23%, Network in peak ~ 560 KiB/s, Network out peak ~ 762 KiB/s
