...
type GetDriverGroupByPayload<T extends DriverGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<DriverGroupByOutputType, T['by']> & {
...
export type DriverWhereInput = {
    ...
    state?: Prisma.EnumDriverStateFilter<"Driver"> | $Enums.DriverState;
};
...
export type DriverScalarWhereWithAggregatesInput = {
    ...
    state?: Prisma.EnumDriverStateWithAggregatesFilter<"Driver"> | $Enums.DriverState;
};
...
export type DriverUpdateInput = {
    state?: Prisma.EnumDriverStateFieldUpdateOperationsInput | $Enums.DriverState;
};
...
export type EnumDriverStateFieldUpdateOperationsInput = {
    set?: $Enums.DriverState;
};
...
export type DriverOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "state", ExtArgs["result"]["driver"]>;
...
export interface DriverFieldRefs {
    ...
    readonly state: Prisma.FieldRef<"Driver", 'DriverState'>;
}
/**
 * Driver findUnique
 */
