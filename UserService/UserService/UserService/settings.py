...
SECRET_KEY = 'django-insecure-g(7ho#l^y%*li@mox#vl2$r66p52(34xz_ysr0_$p@#&s)6x@0'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'ec2-13-215-60-142.ap-southeast-1.compute.amazonaws.com',
    'localhost',
]
...
# Optional: Simple JWT settings for token lifetimes and rotation
SIMPLE_JWT = {
...
AUTH_USER_MODEL = 'CustomUser.CustomerUser'
